...
import static ae.javax.xml.bind.JAXBContext.JAXB_CONTEXT_FACTORY;
...
class ContextFinder {
    ...
    static {
        logger = Logger.getLogger("ae.javax.xml.bind");
        try {
        ...
        throws JAXBException
    {
        try {
            /*
             * ae.javax.xml.bind.context.factory points to a class which has a
    ...
    static JAXBContext find(String factoryId, String contextPath, ClassLoader classLoader, Map properties ) throws JAXBException {
        ...
        // search for a system property second (ae.javax.xml.bind.JAXBContext)
        ...
        if (getContextClassLoader() == classLoader) {
            Class factory = lookupUsingOSGiServiceLoader("ae.javax.xml.bind.JAXBContext");
            if (factory != null) {
     ...
     * However, rt.jar cannot have META-INF/services/ae.javax.xml.bind.JAXBContext
