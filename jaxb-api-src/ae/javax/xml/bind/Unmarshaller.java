 ...
 *       Unmarshaller u = jc.createUnmarshaller();
 * 
 *       ae.javax.xml.stream.XMLStreamReader xmlStreamReader = 
 *           ae.javax.xml.stream.XMLInputFactory().newInstance().createXMLStreamReader( ... );
 * 
 ...
 *       Unmarshaller u = jc.createUnmarshaller();
 * 
 *       ae.javax.xml.stream.XMLEventReader xmlEventReader = 
 *           ae.javax.xml.stream.XMLInputFactory().newInstance().createXMLEventReader( ... );
 * 
 ...
 * {@link ae.javax.xml.bind.helpers.DefaultValidationEventHandler} and it
...
public interface Unmarshaller {
     ...
     *      START_ELEMENT  event.
     * @since JAXB2.0
     * @see #unmarshal(ae.javax.xml.stream.XMLStreamReader, Class)
     */
    public Object unmarshal( ae.javax.xml.stream.XMLStreamReader reader )
        throws JAXBException;
     ...
     * @since JAXB2.0
     */
    public <T> JAXBElement<T> unmarshal( ae.javax.xml.stream.XMLStreamReader reader, Class<T> declaredType ) throws JAXBException;
     ...
     *      START_ELEMENT event.
     * @since JAXB2.0
     * @see #unmarshal(ae.javax.xml.stream.XMLEventReader, Class)
     */
    public Object unmarshal( ae.javax.xml.stream.XMLEventReader reader )
        throws JAXBException;
     ...
     * @since JAXB2.0
     */
    public <T> JAXBElement<T> unmarshal( ae.javax.xml.stream.XMLEventReader reader, Class<T> declaredType ) throws JAXBException;
     ...
     * with {@link ae.javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter}.
     *
     * <p>
     ...
     *      {@link ae.javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter#value()}
     *      refers to this type.
     * @param adapter
